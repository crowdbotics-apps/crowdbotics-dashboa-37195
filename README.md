...
## Project Structure
    ...
    ├── crowdbotics_dashboa_37195  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_dashboa_37195`
...
2. Clone this repo and `cd crowdbotics_dashboa_37195`
